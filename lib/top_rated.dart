...
class Top extends StatefulWidget {
  ...
  final String title;
  @override
  TopRated createState() => TopRated();
}

class TopRated extends State<Top> {
  List<Movie> movies =[];
  ...
  Future<List<Movie>>getMovies() async{
    ...
    var response =await Dio().get(
        'https://api.themoviedb.org/3/movie/top_rated?',queryParameters: {"api_key":"f55fbda0cb73b855629e676e54ab6d8e" }
    );
