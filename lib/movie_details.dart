...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<List<Movie>>getMovies() async{
    ...
    for (var item in response.data["results"] ){
      ...
      movies.add(movie);
      Provider.of<MoviesModel>(context,listen: false,).addMovies(movie);
    }
    return movies;
  }
  ...
  Widget build(BuildContext context) {
    return Consumer<MoviesModel>(builder: (_,model,__){
            ...
            appBar: AppBar(
              ...
              actions: <Widget>[
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (_)=>Fav()));
                  },
                )
              ],
              leading:Icon(
